...
impl ModelConstructionApi {
    ...
    pub fn new() -> Self {
        ...
        Self {
            ...
            open_cv_tree: OpenCVTree { pixels_per_curve: Vec::new(), parent_relations: Vec::new() },
    ...
    pub fn build(&self) -> Result<String, JsValue> {
        ...
        let level_curve_tree = LevelCurveTree::from_open_cv(
            &self.open_cv_tree.pixels_per_curve,
            transformed_parent_relations
        );
