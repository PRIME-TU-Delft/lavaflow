...
export const difficulty_modes = [
	...
	new DifficultyLevel('Easy', 'Take it easy.', 10, 0.4, 3, 40, 30),
	new DifficultyLevel(
		'Medium',
	...
	new DifficultyLevel('Impossible', 'Only Dennis can solve this level.', 3, 0.02, 10, 75, 100)
